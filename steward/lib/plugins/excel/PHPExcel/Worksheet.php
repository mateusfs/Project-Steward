...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
	...
	*/
	...
	{
		$cell = $this->getCell($pCoordinate)->setValue(utf8_encode($pValue));
	...
	{
		$cell = $this->getCell(PHPExcel_Cell::stringFromColumnIndex($pColumn) . $pRow)->setValue(utf8_encode($pValue));
