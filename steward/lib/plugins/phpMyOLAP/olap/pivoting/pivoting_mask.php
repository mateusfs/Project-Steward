...
print "</td>";
print "<td>";
print "<a style='width:120px' class='button' href='#' onclick=\"document.getElementById('divPivoting').style.visibility='hidden';\">".utf8_decode("Próximo")."</a>";
print "</td>";
print "<tr>";
print "</table>";
print "</center>";
