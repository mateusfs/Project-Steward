...
print "<tr>";
	print "<td width=25%>";
	print "<div style='margin-left:20px;margin-top:10px;'><b>Dimensioni</b> del cubo <i>$cubename_sel</i></div>";
...
print "<tr>";
	...
	print "</td>";
	print "<td>";
	print "<a class='button' href='#' onclick='addSD()'>Adicionar</a>";
	print "</td>";
print "</tr>";
print "<tr>";
	print "<td colspan=3>";
	...
	//aggiungi condizioni precedenti (postate)
	$n=strlen($slice);
	...
	print "<a class='button' href='#' onclick='delSD()'>Cancelar</a>";
	print "</td>";
print "</tr>";
print "</table>";
...
print "<tr>";
	...
	print "</td>";
	print "<td align=center>";
	print "<a class='button' href='#' onclick=\"document.getElementById('divSD').style.visibility='hidden';\">Anular</a>";
	print "</td>";
print "</tr>";
print "</table>";
