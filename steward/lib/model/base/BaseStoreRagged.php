...
/**
 * Classe Base da tabela [store_ragged]
 *
 * Modelo criado utilizando a classe "WeeGenerate" desenvolvido por <Juan Carlos Monestel>
 *
 * ATEN��O:
 * - Implementa��es dever�o ser realizadas no modelo StoreRagged
 *
 * SERVER_ADDR: ::1
 * REMOTE_ADDR: ::1
 *
 ...
 * @package model.base
 */
class BaseStoreRagged extends Base {

	const TABLE_NAME = 'store_ragged';
	...
	public static function retrieveByPk($storeId, $persistente = false) {
		...
		$sql = "SELECT * FROM store_ragged WHERE store_id = :store_id " ; 
		try{
