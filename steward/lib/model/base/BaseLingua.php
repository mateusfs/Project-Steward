...
/**
 * Classe Base da tabela [lingua]
 *
 * Modelo criado utilizando a classe "WeeGenerate" desenvolvido por <Juan Carlos Monestel>
 *
 * ATEN��O:
 * - Implementa��es dever�o ser realizadas no modelo Lingua
 *
 * SERVER_ADDR: ::1
 * REMOTE_ADDR: ::1
 *
 ...
 * @package model.base
 */
class BaseLingua extends Base {

	const TABLE_NAME = 'lingua';
	const CODIGO = 'codigo';
	const NOME = 'nome';
	...
	public static function retrieveByPk($codigo, $persistente = false) {
		...
		$sql = "SELECT * FROM lingua WHERE codigo = :codigo " ; 
		try{
