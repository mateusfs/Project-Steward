...
/**
 * Classe Base da tabela [prioridade]
 *
 * Modelo criado utilizando a classe "WeeGenerate" desenvolvido por <Juan Carlos Monestel>
 *
 * ATEN��O:
 * - Implementa��es dever�o ser realizadas no modelo Prioridade
 *
 * SERVER_ADDR: ::1
 * REMOTE_ADDR: ::1
 *
 ...
 * @package model.base
 */
class BasePrioridade extends Base {
	...
	public static function retrieveByPk($codigo, $persistente = false) {
		...
		$sql = "SELECT * FROM prioridade WHERE codigo = :codigo " ; 
		try{
