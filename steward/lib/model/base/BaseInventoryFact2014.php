...
/**
 * Classe Base da tabela [inventory_fact_2014]
 *
 * Modelo criado utilizando a classe "WeeGenerate" desenvolvido por <Juan Carlos Monestel>
 *
 * ATEN��O:
 * - Implementa��es dever�o ser realizadas no modelo InventoryFact2014
 *
 * SERVER_ADDR: ::1
 * REMOTE_ADDR: ::1
 *
 ...
 * @package model.base
 */
class BaseInventoryFact2014 extends Base {

	const TABLE_NAME = 'inventory_fact_2014';
